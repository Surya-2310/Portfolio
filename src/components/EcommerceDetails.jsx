  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f0f] via-[#171717] to-black text-white px-6 py-16">
      <div className="max-w-6xl mx-auto">
        <Link to="/" className="inline-block mb-8 text-orange-400 font-bold hover:text-orange-300">← Back to Portfolio</Link>

        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div>
            <span className="bg-orange-500/20 text-orange-300 px-4 py-2 rounded-full text-sm font-bold">Frontend Project</span>

            <h1 className="text-5xl font-black text-orange-400 mt-6 mb-5">Smart Shopy - E-Commerce Website</h1>
        ...
        <div className="flex flex-wrap gap-4 mt-8">
          <a href="https://smart-shopy-nine.vercel.app/"target="_blank"
            rel="noopener noreferrer"
            className="bg-orange-500 px-7 py-3 rounded-xl font-bold hover:bg-orange-400"
          >Live Project</a>

          <a href="https://github.com/Surya-2310/Smart-Shopy" target="_blank"rel="noopener noreferrer"
      ...
      <div className="bg-[#111] border border-orange-500/20 rounded-3xl p-8 shadow-xl">
        <h2 className="text-2xl font-bold text-orange-300 mb-5">Project Highlights</h2>
